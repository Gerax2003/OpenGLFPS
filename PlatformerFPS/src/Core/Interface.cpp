...
void Interface::update(GLFWwindow* window, int& curScene, std::vector<LowRenderer::Model>& models)
{
	...
	{
		/*if (MouseX > -1.6f && MouseX < 1.7f && MouseY > -0.97f && MouseY < 0.97f)
		{
...
void Interface::creditsButton(std::vector<LowRenderer::Model>& models)
{
	...
	LowRenderer::Model closeModel = { { 8,3.f,-0.01 }, { 0,0,0 }, { 1,1,0.1 }, "resources/close.png", "resources/quad.obj", "resources/skybox", nullptr };
